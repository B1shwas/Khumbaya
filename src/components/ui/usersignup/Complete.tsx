...
export default function Complete({ data, onChange, onNext }: CompleteProps) {
    return (
        ...
        >
            <View className="pt-2">
                <Text className="text-3xl font-jakarta-bold text-text-light">Complete Your Profile</Text>
                <Text className="text-base text-muted-light mt-2">
                    Help us tailor your event experience by providing a few more details about yourself.
                </Text>
            </View>
            ...
            <View className="gap-5 pt-6">
                <View className="flex-row gap-4">
                    <View className="flex-1 gap-2">
                        <Text className="text-sm font-jakarta-semibold text-text-light">City</Text>
                        <TextInput
                            value={data.city}
                    ...
                    <View className="flex-1 gap-2">
                        <Text className="text-sm font-jakarta-semibold text-text-light">Country</Text>
                        <TextInput
                            value={data.country}
                ...
                <View className="gap-2">
                    <Text className="text-sm font-jakarta-semibold text-text-light">Food Preference</Text>
                    <TextInput
                ...
                <View className="gap-2">
                    <Text className="text-sm font-jakarta-semibold text-text-light">Bio</Text>
                    <TextInput
                        value={data.bio}
