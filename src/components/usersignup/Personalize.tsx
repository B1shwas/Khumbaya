      ...
      <View className="mt-20 gap-6">
          ...
          <View className="flex-row items-start gap-4">
            ...
            <View className="flex-1">
              ...
              <Text className="text-sm text-muted-light">
                Your profile and cover photos will be visible to your event
                planner and vendors on the shared dashboard.
              </Text>
            </View>
          </View>
        </View>
        ...
        >
          ...
          <Text className="text-xs text-muted-light flex-1">
            I agree to the Terms of Service and Privacy Policy regarding media
            usage.
          </Text>
        </Pressable>
      </View>
