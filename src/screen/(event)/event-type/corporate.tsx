...
const eventTypes = [
  { icon: "people", label: "Conference", iconColor: "#6366f1" },
  { icon: "chatbubbles", label: "Meeting", iconColor: "#3b82f6" },
  { icon: "briefcase", label: "Seminar", iconColor: "#8b5cf6" },
  { icon: "trophy", label: "Award", iconColor: "#f59e0b" },
  { icon: "calendar", label: "Product Launch", iconColor: "#10b981" },
  { icon: "people-outline", label: "Networking", iconColor: "#06b6d4" },
];
