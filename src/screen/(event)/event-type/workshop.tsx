...
const eventTypes = [
  { icon: "school", label: "Training", iconColor: "#10b981" },
  { icon: "chatbubbles", label: "Panel", iconColor: "#3b82f6" },
  { icon: "bulb", label: "Hackathon", iconColor: "#f59e0b" },
  { icon: "document-text", label: "Webinar", iconColor: "#6366f1" },
  { icon: "people", label: "Meetup", iconColor: "#8b5cf6" },
  { icon: "book", label: "Class", iconColor: "#ec4899" },
];
