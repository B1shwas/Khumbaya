...
const eventTypes = [
  { icon: "gift", label: "Kids Party", iconColor: "#f59e0b" },
  { icon: "sparkles", label: "Surprise", iconColor: "#ec4899" },
  { icon: "people", label: "Adult Party", iconColor: "#6366f1" },
  { icon: "restaurant-outline", label: "Dinner", iconColor: "#10b981" },
  { icon: "camera", label: "Milestone", iconColor: "#8b5cf6" },
  { icon: "heart", label: "Anniversary", iconColor: "#ec4899" },
];
