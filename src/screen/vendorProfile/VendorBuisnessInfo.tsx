    ...
    <View className="flex-1 bg-background-light dark:bg-background-dark">
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          <View className="mb-8">
            <Text
              className="text-[32px] font-bold leading-tight tracking-tight mb-2 text-white"
              style={{ color: "#0f172a" }}
            >
              Business Details
            </Text>
            ...
            >
              ...
              Let's start with the basics so couples can easily find and book
              you for their special day.
            </Text>
          </View>
            ...
            <View className="gap-2">
              ...
              >
                <Text
                  ...
                  style={{ color: experience ? "#0f172a" : "#9ca3af" }}
                >
