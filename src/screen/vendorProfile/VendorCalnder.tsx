        ...
        <View className="flex-row items-center justify-between">
          {location ? (
            ...
            <View className="flex-row -space-x-2">
              <Image
                source={{
                  uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuDvSIUsCKFYMtY0QH6MRH6TWE6HO-q9Icy3jLBGq1CI1SlEq3csCQrYqiHl3jAgRDzTqrsP5-ZHeHDvK_YAi6oT8w0ItL-yRZYxd_lzaJJdUj1YMU5jLNtXKonzWWG4fChDv5WvkvrnMEvrcWVwWu50pKXKWn39qZL315cpP4p0fgQFYHb9_TG2P-PZ9EiwpfbGa32EWuQ35J9VPvRcEY6bnLIhuaFbP_f0RJvDRkEi_23E2GyjeO2qMoHSToFWCf-UnKCEp75Gjmc",
                }}
                className="w-6 h-6 rounded-full border-2 border-white dark:border-slate-900"
              />
              <Image
                source={{
                  uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuBsyub0wZrSqBfTSk42lcQLgZCpGOEQBx0Vf8MTRlxaSqcoMsH7pzzJkT-DlEhYP0vWWBjJ298dBrLHwXTO4J85T62CcTrAhfBLqUED0p2n9mcQkQLJ-mfQyBqORtvV72aSNzQcF99JIYbaQ7yO3DKoHyoXw7z1Ez4cPvRz4K_fPmjQe4WoZX5GcJN4reTRwd87fOKSPXPVRPRTuwHQsjCK0ZC86Q1DhETF4YiOzJM4cTwcxXLLvgtrAks-yKlbl5zvSLVEshueMs4",
                }}
                className="w-6 h-6 rounded-full border-2 border-white dark:border-slate-900"
              />
              <View className="w-6 h-6 rounded-full border-2 border-white dark:border-slate-900 bg-slate-200 dark:bg-slate-700 items-center justify-center">
                <Text className="text-[8px] font-bold text-slate-600 dark:text-slate-300">
                  +3
                </Text>
              </View>
            </View>
                ...
                >
                  {day.isToday ? (
                    <View className="absolute inset-0 m-1.5 items-center justify-center">
                      ...
                      <Text
                        className={`text-sm ${day.isCurrentMonth ? "text-white" : "text-slate-400"}`}
                      >
                        {day.day}
                      </Text>
                    </View>
                    ...
                    // dark:text-white
                    <Text
                      className={`text-sm ${day.isCurrentMonth ? "text-slate-900 " : "text-slate-400"}`}
                    >
                      {day.day}
                    </Text>
                  )}
