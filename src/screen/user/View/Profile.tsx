...
const MenuItem = ({ label, icon, badge, onPress }: MenuItemProps) => {
    ...
    return (
        <Pressable
            className="flex-row items-center gap-4 bg-background-light border border-[#e6dbe0] p-4 rounded-xl shadow-md active:scale-[0.98] transition-transform"
            onPress={onPress}
        >
...
export default function Profile() {
    ...
    const pressedFunction = () => {
        console.log('This is the pressed function')
        logout();
        ...
        <View className="flex-1 bg-white">
            ...
            >
                ...
                <View className="px-4 mb-6">
                    <View
                        className="flex-row items-center justify-between gap-4 rounded-2xl border border-[#e6dbe0] bg-background-light p-5 shadow-sm"
                    >
                ...
                <View className="mt-8 px-6 pb-8 items-center gap-4 ">
                    <Pressable className="w-full rounded-lg py-2 bg-primary items-center h-12 justify-center"
                        onPress={pressedFunction}>
                        <Text className="text-center font-semibold text-base text-[#ffffff]">
                            Log Out
                        </Text>
                    </Pressable>
