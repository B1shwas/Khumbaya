...
import BusinessDetail from "@/src/components/vendorForm/BuisnessDetail";
...
const PORTFOLIO_ITEM_SIZE =
  (SCREEN_WIDTH - PORTFOLIO_PADDING * 2 - PORTFOLIO_GAP * 2) / 3;
const MAX_PHOTOS = 9;
...
function StepCategories({
  ...
  return (
    <View>
      <Text
        className="text-[28px] font-bold leading-tight pt-2 pb-3"
        style={{ color: "#181114" }}
      >
    ...
    >
      <View
        ...
        style={{
          width: 48,
          height: 48,
          backgroundColor: selected ? "#ffffff" : "#fcebf4",
        }}
      >
...
function StepAdditionalDetails() {
  return (
    <View>
      ...
      <Text className="text-base font-normal leading-relaxed text-slate-500">
        Add more details to make your profile stand out. (Placeholder for Step
        3)
      </Text>
    </View>
  );
  ...
  return (
    <View>
      ...
      <View className="items-center mb-4">
        <Text className="text-2xl font-bold" style={{ color: "#181114" }}>
          You're all set!
        </Text>
        <Text className="text-slate-500 text-center mt-2">
          Once you activate, our team will verify your details within{" "}
          <Text className="text-primary font-bold">24 hours</Text>.
        </Text>
      </View>
