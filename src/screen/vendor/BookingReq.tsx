    ...
    PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        if (gestureState.dy > 0) {
          ...
          const opacityValue = Math.max(0, 1 - (gestureState.dy / (screenHeight * 0.5)));
              ...
              <View className="bg-white rounded-t-3xl min-h-[85%]">
                ...
                >
                    ...
                    {showEventDropdown && (
                      <View className="absolute top-24 left-6 right-6 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                        {MOCK_EVENTS.map((event) => (
                          ...
                          >
                            <Text className="text-text-primary">{event.label}</Text>
                          </Pressable>
                        ))}
                      </View>
                    )}
                  ...
                  <Text className="text-xs text-gray-500 text-center leading-relaxed px-2">
                    By sending this request, you agree to our terms of service. The
                    vendor will be notified immediately and usually responds within
                    24 hours.
                  </Text>
                </ScrollView>
