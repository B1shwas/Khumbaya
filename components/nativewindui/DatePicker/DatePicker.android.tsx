    ...
    <View className="flex-row gap-3 px-4 py-2">
      ...
      {props.mode.includes('date') && (
        <View className={cn('flex-1 gap-1', props.materialDateClassName)}>
          <Text className={cn('text-xs font-medium text-muted-foreground tracking-wide uppercase pl-1 text-center', props.materialDateLabelClassName)}>
      ...
      {props.mode.includes('time') && (
        <View className={cn('flex-1 gap-1 drop-shadow-md  ', props.materialTimeClassName)}>
